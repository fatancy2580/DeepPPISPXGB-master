# The ROC curve of the DeepPPISP-XGB and four machine learning algorithms on the test of preprocessing features
...
if __name__ == '__main__':
    file1 = sys.argv[1]  #global&local_feature_training_set
    file2 = sys.argv[2]  #global&local_feature_testing_set
    protein_train = pd.read_csv(file1)
    xtrain = protein_train.iloc[:, 1:1028]   #contain row index
